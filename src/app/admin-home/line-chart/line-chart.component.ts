...
export class LineChartComponent {
  ...
  public lineChartData:Array<any> = [
    {data: [1.65, 59, 80, 81, 56, 55, 40 , 34, 74,54,44,56], label: 'Total spent per month'},
    {data: [28, 48, 40, 19, 86, 27, 90,76,3,45,6,34], label: 'Series B'},
    {data: [18, 48, 77, 9, 100, 27, 40,89,45,76,4,45], label: 'Series C'}
  ];
